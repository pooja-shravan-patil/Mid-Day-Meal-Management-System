...
Public Class Dailyentryrpt
    ...
    Private Sub CrystalReportViewer1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CrystalReportViewer1.Load
        ...
        cn.Open()
        da = New SqlDataAdapter("select * from dentryview", cn)
        da.Fill(ds, "dentryview")
    ...
    Private Sub Dailyentryrpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
